...
- **Hannos Stil ist das Relevante.** Der persönliche Sprachstil (Wortwahl, Satzbau, Aussageweise, Aussprache-Eigenheiten, Reihenfolge der Gedanken) bleibt erhalten. Keine fremden Formulierungen, keine literarische Glättung, keine Umformulierung „weil es so schöner klingt".
- **Grammatik und Artefakte korrigieren:** Diktier- und Spracherkennungs-Artefakte werden aktiv repariert, vor allem Grammatikfehler, STT-Aussetzer, Wortverdreher, Verdopplungen, falsche Verbformen, abgebrochene Sätze, falsche Konjugationen, falsche Artikel. Drei Korrekturdurchgänge (Sauna-Prinzip), bis der Text lesbar ist, ohne Hannos Stimme zu verfälschen. Beispiele: „römischen Bart" → „römischen Bad", „hirichliche Sauna" → „richtige Sauna", „Boglocket" → „Loket", „Borg-Lock-Hit" → „Burg Loket", „Schwimmbäck" → „Schwimmbecken", „Sträge" → „Straße", „Badamangel" → „Bademantel", „Kuhhotel" → „Kurhotel", „hat es aufgefallen" → „ist es aufgefallen", „die Hotel ist" → „das Hotel ist", „haben einen ewig langer Marsch" → „war ein ewig langer Marsch", „das am Vortag bin ich im Im Prinzip" → „am Vortag bin ich im Prinzip". Was Hanno inhaltlich gemeint hat, bleibt unangetastet. Was STT verhunzt hat, wird repariert.
