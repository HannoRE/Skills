...
- **Hannos Stil erhalten:** Wortlaut und Aussageweise aus dem Diktat beibehalten — keine fremden Formulierungen, keine literarische Glättung.
- **Aber glätten und korrigieren:** Offensichtliche Spracherkennungs- und Diktier-Artefakte (STT-Aussetzer, Wortverdreher, Verdopplungen, falsche Verbformen, abgebrochene Sätze) werden korrigiert, damit der Text lesbar wird. Beispiele: „römischen Bart" → „römischen Bad", „hirichliche Sauna" → „richtige Sauna", „Boglocket" → „Loket", „Borg-Lock-Hit" → „Burg Loket", „Schwimmbäck" → „Schwimmbecken", „Sträge" → „Straße", „Badamangel" → „Bademantel", „Kuhhotel" → „Kurhotel", „hat es aufgefallen" → „ist es aufgefallen", „die Hotel ist" → „das Hotel ist". Was Hanno inhaltlich gemeint hat, bleibt unangetastet. Was STT verhunzt hat, wird repariert.
