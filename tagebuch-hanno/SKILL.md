...
- **Hannos Stil erhalten:** Formulierungen, Satzbau und Wortwahl aus dem Diktat möglichst beibehalten. Nicht eigenmächtig „literarischer", „korrekter" oder flüssiger formulieren. Wenn Hanno einen Satz unvollständig lässt, nicht eigenmächtig ergänzen. Hannos Worte sind die Quelle der Wahrheit.
- **STT-Artefakte aktiv korrigieren:** Spracherkennungsfehler (z. B. „Bart" → „Bad", „hirichliche" → „kirchliche", „Lätt" → „Latte", „schummerig" → „schwindlig", „Boglocket" → „Loket", „Borg-Lock-Hit" → „Burg Loket") werden **korrigiert**, nicht verbatim übernommen. Das gilt für **neue UND bestehende Einträge** — bestehende Tagebuch-Einträge werden beim nächsten Lesen einmalig nach STT-typischen Verwechslungen durchsucht und korrigiert. Eigennamen, Fremdwörter und korrekt transkribierte Wörter bleiben unverändert.
